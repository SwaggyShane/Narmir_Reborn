/**
 * Combat System v2 — individual trooper HP, injury states, walls, ladders.
 * Live path: combat-wrappers → combat-resolver → this module.
 * Turn recovery: game/lib/injury-recovery.js (processTurn playlist).
 */
...
const TROOP_BASE_STATS = {
  ...
  thralls: { hp: 110, dmg: 8, hpLevelScale: 0, dmgLevelScale: 0 },
...
const GLOBAL_DAMAGE_MULTIPLIER = 1.05;
...
function calculateIndividualTroopDmg(troopType, weaponResearch, troopLevel, racialModifier = 1.0) {
  ...
  return (baseDmg + weaponBonus + levelBonus) * GLOBAL_DAMAGE_MULTIPLIER;
}
