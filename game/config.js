...
const config = {
  ...
  SPELL_DEFS: {
    ...
    mystic_lock: { minSB: 150, tier: 1, effect: "research", damageType: "none", desc: "Makes 2 enemy spy attempts fail next turn" },
    ...
    // ===== DIVINATION SPELLS =====
    detect_presence: { minSB: 100, tier: 1, effect: "research", damageType: "none", desc: "Reveals nearest enemy kingdom location for 1 turn" },
    ...
    chrono_vision: { minSB: 520, tier: 3, effect: "research", damageType: "none", desc: "Reveals enemy plans for next 3 turns" },
    ...
    prophetic_dream: { minSB: 800, tier: 4, effect: "friendly", damageType: "none", desc: "+200% to next divination spell for 3 turns" },
    ...
    see_all_timelines: { minSB: 1050, tier: 5, effect: "research", damageType: "none", desc: "Reveals all possible outcomes of next 5 turns" },
    ...
    command_word: { minSB: 120, tier: 1, effect: "debuff", damageType: "mental", desc: "Enemy cannot act next turn" },
