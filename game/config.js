...
const config = {
  ...
  INVENTORY_ITEMS: {
    ...
    orcs_pamphlet: { name: "Orc Pamphlet", desc: "\"10 Reasons Orcs Are Actually Quite Misunderstood\". A surprisingly persuasive read.", rarity: "junk" },
    moldy_cheese: { name: "Impressively Moldy Cheese", desc: "From an unknown era. The mold has evolved its own culture.", rarity: "junk" },
    broken_compass: { name: "Broken Compass", desc: "Spins wildly and points in all directions simultaneously. Confidently wrong.", rarity: "junk" },
    empty_potion: { name: "Empty Potion Bottle", desc: "A bottle with a faint magical smell. Whatever was in it is gone.", rarity: "junk" },
    ancient_coin: { name: "Ancient Coin", desc: "From a civilization that never actually existed. Somehow.", rarity: "junk" },
    glowing_stone: { name: "Glowing Stone", desc: "Glows faintly at night and only at night. Useless during the day.", rarity: "junk" },
    tattered_map: { name: "Tattered Map", desc: "So tattered you can't tell where it points to anymore. Navigation not recommended.", rarity: "junk" },
    cursed_amulet: { name: "Cursed Amulet", desc: "Cursed to give the finder mild inconveniences. Nothing serious. Probably.", rarity: "junk" },
    petrified_carrot: { name: "Petrified Carrot", desc: "A carrot that has somehow turned to stone. Nutritional value: unclear.", rarity: "junk" },
    love_poem: { name: "Coded Love Poem", desc: "Written in a code no one has ever deciphered. The passion is palpable but mysterious.", rarity: "junk" },
    wanted_poster: { name: "Wanted Poster", desc: "For someone nobody remembers. The reward was apparently a wedge of cheese.", rarity: "junk" },
    broken_lute: { name: "Broken Lute", desc: "All strings snapped at exactly the same length. Suspicious.", rarity: "junk" },
    mysterious_egg: { name: "Mysterious Egg", desc: "Of unknown origin. Never hatches. Vibrates slightly on Tuesdays.", rarity: "junk" },
    withered_flower: { name: "Withered Flower", desc: "Bloomed 200 years ago and never wilted. Botanists are baffled.", rarity: "junk" },
    chipped_crown: { name: "Chipped Crown", desc: "Definitely not real gold. Probably. The chip is suspicious.", rarity: "junk" },
    faded_portrait: { name: "Faded Portrait", desc: "Of someone nobody can identify. They look very important though.", rarity: "junk" },
    warped_flute: { name: "Warped Flute", desc: "Plays notes that shouldn't exist in any musical scale. Strangely beautiful.", rarity: "junk" },
    golden_acorn: { name: "Golden Acorn", desc: "Somehow made of gold but weighs nothing. Physics is concerned.", rarity: "junk" },
    incomplete_puzzle: { name: "Incomplete Puzzle", desc: "Missing exactly one piece. Always the same piece. The piece is never found.", rarity: "junk" },
    bottled_scream: { name: "Bottled Scream", desc: "A bottle containing what sounds suspiciously like a scream. Handle with care.", rarity: "junk" },
    library_card: { name: "Library Card", desc: "From a library that burned down 500 years ago. Still valid, technically.", rarity: "junk" },
    crystallized_honey: { name: "Crystallized Honey", desc: "So old it has become crystalline and slightly sentient. Tastes okay though.", rarity: "junk" },
    stolen_ring: { name: "Stolen Ring", desc: "Has 'stolen' engraved on the inside. Someone was very honest about this.", rarity: "junk" },
    night_light: { name: "Midnight Light", desc: "A magical light that only works at midnight. Schedules its illumination poorly.", rarity: "junk" },
    ghost_ink: { name: "Ghost Ink", desc: "Invisible except under moonlight. Useful for exactly one situation.", rarity: "junk" },
    clock_hands: { name: "Orphaned Clock Hands", desc: "Two hands with no clock, always pointing in different directions. Time is relative.", rarity: "junk" },
  ...
  RESOURCE_BUILDING_CONFIG: {
    woodyard:     { type: 'wood',  stage: 1, workersPerBuilding: 10,  yield: 1, yieldEvery: 1 },
    lumber_camp:  { type: 'wood',  stage: 2, workersPerBuilding: 25,  yield: 5, yieldEvery: 1 },
    sawmill:      { type: 'wood',  stage: 3, workersPerBuilding: 75,  yield: 15, yieldEvery: 1 },
    gravel_pit:   { type: 'stone', stage: 1, workersPerBuilding: 30,  yield: 1, yieldEvery: 1 },
    blockfield:   { type: 'stone', stage: 2, workersPerBuilding: 75,  yield: 5, yieldEvery: 1 },
    stone_quarry: { type: 'stone', stage: 3, workersPerBuilding: 225, yield: 15, yieldEvery: 1 },
    open_pit:     { type: 'iron',  stage: 1, workersPerBuilding: 20,  yield: 1, yieldEvery: 1 },
    strip_mine:   { type: 'iron',  stage: 2, workersPerBuilding: 50,  yield: 5, yieldEvery: 1 },
    deep_mine:    { type: 'iron',  stage: 3, workersPerBuilding: 150, yield: 15, yieldEvery: 1 },
  },
