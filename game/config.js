...
const config = {
  ...
  INVENTORY_ITEMS: {
    ...
    orcs_pamphlet: { name: "Orc Pamphlet", desc: '"10 Reasons Orcs Are Actually Quite Misunderstood." Surprisingly well-argued.', rarity: "junk" },
    moldy_cheese: { name: "Moldy Cheese Wheel", desc: "Impressively moldy, from an unknown era. The mold may be the valuable part.", rarity: "junk" },
    broken_compass: { name: "Broken Compass", desc: "Spins wildly and points in all directions. Technically still working, in a sense.", rarity: "junk" },
    empty_potion: { name: "Empty Potion Bottle", desc: "Has a faint magical smell. Whatever was inside is long gone.", rarity: "junk" },
    ancient_coin: { name: "Ancient Coin", desc: "From a civilization that never actually existed. Numismatists are baffled.", rarity: "junk" },
    glowing_stone: { name: "Glowing Stone", desc: "Glows faintly at night, and only at night. Utterly inert by day.", rarity: "junk" },
    tattered_map: { name: "Tattered Map", desc: "So tattered you can't tell where it points to anymore. Once led somewhere, probably.", rarity: "junk" },
    cursed_amulet: { name: "Cursed Amulet", desc: "Cursed to give the wearer mild inconveniences. Stubbed toes, mostly.", rarity: "junk" },
    petrified_carrot: { name: "Petrified Carrot", desc: "A carrot that has somehow turned to stone. The rabbits are disappointed.", rarity: "junk" },
    love_poem: { name: "Love Poem", desc: "Written in a code no one has ever deciphered. Presumably heartfelt.", rarity: "junk" },
    wanted_poster: { name: "Wanted Poster", desc: "For someone nobody remembers. The reward has long since expired.", rarity: "junk" },
    broken_lute: { name: "Broken Lute", desc: "All the strings snapped at exactly the same length. Suspicious.", rarity: "junk" },
    mysterious_egg: { name: "Mysterious Egg", desc: "Of unknown origin. Never hatches. Best not to poke it.", rarity: "junk" },
    withered_flower: { name: "Withered Flower", desc: "Bloomed 200 years ago and never wilted, until it apparently did.", rarity: "junk" },
    chipped_crown: { name: "Chipped Crown", desc: "Definitely not real gold, probably. A tiara for the humble.", rarity: "junk" },
    faded_portrait: { name: "Faded Portrait", desc: "Of someone nobody can identify. They look important, though.", rarity: "junk" },
    warped_flute: { name: "Warped Flute", desc: "Plays notes that shouldn't exist. The neighbors have complained.", rarity: "junk" },
    golden_acorn: { name: "Golden Acorn", desc: "Somehow made of gold but weighs nothing. Physicists are not consulted.", rarity: "junk" },
    incomplete_puzzle: { name: "Incomplete Puzzle", desc: "Missing exactly one piece — always the same piece, no matter how many times you buy it.", rarity: "junk" },
    bottled_scream: { name: "Bottled Scream", desc: "Contains what sounds suspiciously like a scream. Do not shake.", rarity: "junk" },
    library_card: { name: "Library Card", desc: "From a library that burned down 500 years ago. Still technically valid.", rarity: "junk" },
    crystallized_honey: { name: "Crystallized Honey", desc: "So old it's turned crystalline, and possibly slightly sentient.", rarity: "junk" },
    stolen_ring: { name: "Stolen Ring", desc: "Has 'stolen' engraved on the inside. Whoever made it was not subtle.", rarity: "junk" },
    night_light: { name: "Night Light", desc: "A magical light that only works at midnight. Otherwise, decorative.", rarity: "junk" },
    ghost_ink: { name: "Ghost Ink", desc: "Invisible except under moonlight. A favorite of dramatic letter-writers.", rarity: "junk" },
    clock_hands: { name: "Clock Hands", desc: "Two clock hands with no clock, always pointing in different directions.", rarity: "junk" },
    // From fantasy_junk_prizes.md
    map_to_nowhere: { name: "Map to Nowhere", desc: "A map to a location that no longer exists.", rarity: "junk" },
    rusty_butter_knife: { name: "\"Magic\" Butter Knife", desc: "A \"magic\" sword that's just a rusty butter knife.", rarity: "junk" },
    expired_invisibility_potion: { name: "Expired Potion of Invisibility", desc: "Potion of Invisibility — expired, now just water.", rarity: "junk" },
    small_dragon_scale: { name: "Slightly Used Dragon Scale", desc: "One slightly used dragon scale (from a very small dragon).", rarity: "junk" },
    kings_lost_sock: { name: "The King's Lost Sock", desc: "The King's lost sock. Smells like regret.", rarity: "junk" },
    useless_chest_key: { name: "Useless Treasure Chest Key", desc: "A treasure chest key... for a chest long ago plundered.", rarity: "junk" },
    poverty_glow_ring: { name: "Enchanted Poverty Ring", desc: "Enchanted ring that only glows when you're broke.", rarity: "junk" },
    goblins_lucky_tooth: { name: "Goblin's Lucky Tooth", desc: "Goblin's lucky tooth. It bites back.", rarity: "junk" },
    scroll_of_annoyance: { name: "Scroll of Mild Annoyance", desc: "Scroll of Summoning that calls forth mild annoyance.", rarity: "junk" },
    mismatched_boots_of_speed: { name: "Mismatched Boots of Speed", desc: "Boots of Speed — left foot only, and they're mismatched.", rarity: "junk" },
    crystal_ball_yesterday: { name: "Crystal Ball of Yesterday", desc: "A crystal ball showing yesterday's weather.", rarity: "junk" },
    houseplant_love_potion: { name: "Houseplant Love Potion", desc: "Love potion that works on houseplants.", rarity: "junk" },
    cursed_amulet_bad_decisions: { name: "Amulet of Bad Decisions", desc: "Cursed amulet: +1 to bad decisions.", rarity: "junk" },
    prophecy_fragment_lunch: { name: "Prophecy Fragment (About Lunch)", desc: "Fragment of an ancient prophecy... about lunch.", rarity: "junk" },
    wand_always_misses: { name: "Wand of Missed Missiles", desc: "Wand of Magic Missiles that always misses.", rarity: "junk" },
    bag_of_disappointment: { name: "Bag of Mild Disappointment", desc: "Bag of Holding? More like Bag of Mild Disappointment.", rarity: "junk" },
    boring_half_artifact: { name: "Half of a Legendary Artifact", desc: "One half of a legendary artifact. The boring half.", rarity: "junk" },
    unlit_phoenix_feather: { name: "Unlit Phoenix Feather", desc: "Phoenix feather that refuses to ignite.", rarity: "junk" },
    tavern_treasure_map: { name: "Map to Tavern Treasure", desc: "Map to buried treasure... buried under a tavern.", rarity: "junk" },
    pink_camouflage_cloak: { name: "Bright Pink Camouflage Cloak", desc: "Elven cloak of camouflage — bright pink.", rarity: "junk" },
    sore_muscle_potion: { name: "Potion of Sore Muscles", desc: "Potion of Strength: makes your muscles sore.", rarity: "junk" },
    weather_complaining_skull: { name: "Weather-Complaining Skull", desc: "Talking skull that only complains about the weather.", rarity: "junk" },
    judgmental_golden_idol: { name: "Judgmental Golden Idol", desc: "Golden idol with a very judgmental face.", rarity: "junk" },
    boil_water_spellbook_page: { name: "\"How to Boil Water, Magically\"", desc: "Spellbook page: \"How to Boil Water, Magically.\"", rarity: "junk" },
    heartburn_resistance_ring: { name: "Ring of Heartburn Resistance", desc: "Ring of Fire Resistance... but only to mild heartburn.", rarity: "junk" },
    participation_medal: { name: "Hero's Participation Medal", desc: "A hero's medal for participation.", rarity: "junk" },
    painted_rock_dragon_egg: { name: "\"Dragon Egg\" (Painted Rock)", desc: "Dragon egg... it's a rock painted green.", rarity: "junk" },
    permanently_invisible_ink: { name: "Permanently Invisible Ink", desc: "Invisible ink that stays invisible forever.", rarity: "junk" },
    unlucky_rabbits_foot: { name: "Unlucky Rabbit's Foot", desc: "Lucky rabbit's foot from a very unlucky rabbit.", rarity: "junk" },
    mirror_of_truth: { name: "Mirror of Truth", desc: "Mirror of Truth: tells you you're ugly.", rarity: "junk" },
    bad_advice_coin: { name: "Coin of Bad Advice", desc: "Ancient coin that only buys bad advice.", rarity: "junk" },
    broomstick_staff_of_power: { name: "\"Staff of Power\" (Broomstick)", desc: "Staff of Power... it's a broomstick.", rarity: "junk" },
    curse_of_sneezing: { name: "Curse of Endless Sneezing", desc: "Curse of Endless Sneezing.", rarity: "junk" },
    teleport_scroll_nowhere: { name: "Scroll to Nowhere", desc: "Teleportation scroll to the middle of nowhere.", rarity: "junk" },
    vinegar_chalice: { name: "Chalice of Vinegar", desc: "Chalice that turns wine into vinegar.", rarity: "junk" },
    book_of_failure_recipes: { name: "Book of Forbidden Knowledge", desc: "Book of Forbidden Knowledge: recipes for failure.", rarity: "junk" },
    cloak_lifts_spirits: { name: "Cloak of Lifted Spirits", desc: "Cloak of Levitation that only lifts your spirits.", rarity: "junk" },
    incomplete_goblin_ears: { name: "Incomplete Goblin Ear Collection", desc: "Goblin ear collection — incomplete.", rarity: "junk" },
    beans_of_disappointment: { name: "Beans of Disappointment", desc: "Magic beans that grow disappointment.", rarity: "junk" },
    forgotten_kings_crown: { name: "Crown of the Forgotten King", desc: "Crown of the Forgotten King. No one remembers him.", rarity: "junk" },
    arrow_of_squirrel_slaying: { name: "Arrow of Squirrel Slaying", desc: "Arrow of Slaying... squirrels.", rarity: "junk" },
    potion_of_the_runs: { name: "\"Potion of Flight\"", desc: "Potion of Flight: gives you the runs.", rarity: "junk" },
    singing_sword_shanties: { name: "Singing Sword of Shanties", desc: "Singing sword that only knows tavern shanties.", rarity: "junk" },
    hangover_crystal: { name: "Hangover-Predicting Crystal", desc: "Crystal that predicts your next hangover.", rarity: "junk" },
    zombie_attracting_amulet: { name: "Amulet That Attracts Zombies", desc: "Amulet against undead... attracts zombies instead.", rarity: "junk" },
    dried_fountain_of_youth_map: { name: "Map to a Dried-Up Fountain", desc: "Map to the Fountain of Youth — dried up.", rarity: "junk" },
    helm_of_foolishness: { name: "\"Helm of Brilliance\"", desc: "Helm of Brilliance: makes you look foolish.", rarity: "junk" },
    bag_of_lint: { name: "Bag of Endless Lint", desc: "Bag of endless... lint.", rarity: "junk" },
    flower_resurrection_scroll: { name: "Scroll of Flower Resurrection", desc: "Scroll of Resurrection: revives wilted flowers.", rarity: "junk" },
    excalibore: { name: "\"Excali-bore\"", desc: "Legendary blade \"Excali-bore.\"", rarity: "junk" },
    orb_of_static: { name: "Orb of Static", desc: "Orb of Scrying that only shows static.", rarity: "junk" },
    dramatically_squeaky_boots: { name: "Dramatically Squeaky Boots", desc: "Boots that squeak dramatically with every step.", rarity: "junk" },
    ghost_ex_love_letter: { name: "Love Letter From a Ghost", desc: "Love letter from a ghost ex.", rarity: "junk" },
    dice_of_fate_always_one: { name: "Dice of Fate (Always 1)", desc: "Dice of Fate that always roll 1.", rarity: "junk" },
    mild_polymorph_potion: { name: "Mild Potion of Polymorph", desc: "Potion of Polymorph: turns you into a slightly different person.", rarity: "junk" },
    drunk_bards_map: { name: "Drunk Bard's Treasure Map", desc: "Treasure map drawn by a drunk bard.", rarity: "junk" },
    shield_of_insecurities: { name: "Shield of Insecurities", desc: "Shield of Reflection: reflects your insecurities.", rarity: "junk" },
    hair_igniting_wand: { name: "Hair-Igniting Wand", desc: "Wand that shoots sparks... and sets your hair on fire.", rarity: "junk" },
    tome_101_ways_lose_kingdom: { name: "\"101 Ways to Lose a Kingdom\"", desc: "Ancient tome: \"101 Ways to Lose a Kingdom.\"", rarity: "junk" },
    ring_hopes_dreams: { name: "Ring of Vanishing Hopes", desc: "Ring of Invisibility: works on your hopes and dreams.", rarity: "junk" },
    dragons_hoard_lint: { name: "Dragon's Hoard (One Copper and Lint)", desc: "Dragon's hoard: one copper piece and lint.", rarity: "junk" },
    healing_potion_regret: { name: "Potion That Tastes Like Regret", desc: "Healing potion that tastes like regret.", rarity: "junk" },
    prophecy_stone_inconvenience: { name: "Stone of Mild Inconvenience", desc: "Prophecy stone that foretells mild inconvenience.", rarity: "junk" },
    clashing_cloak: { name: "Cloak of Many Clashing Colors", desc: "Cloak of Many Colors: all of them clash.", rarity: "junk" },
    key_to_ruined_city: { name: "Key to a Ruined City", desc: "Key to the city... of ruins.", rarity: "junk" },
    pigeon_summoning_whistle: { name: "Pigeon-Summoning Whistle", desc: "Familiar summoning whistle: calls pigeons.", rarity: "junk" },
    dice_weighted_against_you: { name: "Enchanted Dice (Rigged)", desc: "Enchanted dice: weighted against you.", rarity: "junk" },
    mirror_shield_worst_side: { name: "Mirror Shield of Your Worst Side", desc: "Mirror Shield that shows your worst side.", rarity: "junk" },
    bottle_of_more_wishes: { name: "Bottle of \"More Wishes\"", desc: "Bottle of genie wishes: one left, it's \"more wishes.\"", rarity: "junk" },
    el_dorado_thrift_shop_map: { name: "Map to El Dorado (Thrift Shop)", desc: "Map to El Dorado: it's a thrift shop.", rarity: "junk" },
    sword_dulls_on_contact: { name: "\"Sword of Sharpness\"", desc: "Sword of Sharpness: dulls on contact.", rarity: "junk" },
    book_of_spell_typos: { name: "Book of Spells (All Typos)", desc: "Book of Spells: all typos.", rarity: "junk" },
    orc_charisma_crown: { name: "Crown of Orc Charisma", desc: "Crown that gives +1 charisma to orcs.", rarity: "junk" },
    teleport_ring_last_death: { name: "Ring of Returning to Death", desc: "Teleport ring to the last place you died.", rarity: "junk" },
    potion_everything_faster: { name: "\"Potion of Speed\" (Backwards)", desc: "Potion of Speed: makes everything else faster.", rarity: "junk" },
    three_leaf_clover: { name: "Lucky Three-Leaf Clover", desc: "Lucky charm: a four-leaf clover with three leaves.", rarity: "junk" },
    ancient_broken_pottery: { name: "Ancient Broken Pottery", desc: "Ancient relic: broken pottery.", rarity: "junk" },
    dimly_glowing_staff: { name: "\"Staff of Light\"", desc: "Staff of Light: dimly glows.", rarity: "junk" },
    curse_swap_scroll: { name: "Curse Removal Scroll (Not Really)", desc: "Curse removal scroll: applies another curse.", rarity: "junk" },
    tomato_stained_cape: { name: "Tomato-Stained Hero's Cape", desc: "Hero's cape: stained with tomato sauce.", rarity: "junk" },
    plastic_crystal_skull: { name: "Plastic Crystal Skull", desc: "Crystal skull: it's plastic.", rarity: "junk" },
    rug_with_attitude: { name: "Rug With Attitude", desc: "Flying carpet: rug with attitude.", rarity: "junk" },
    toad_love_elixir: { name: "Toad Love Elixir", desc: "Love elixir: works on toads.", rarity: "junk" },
    wrong_dimension_vault_key: { name: "Key to a Vault in the Wrong Dimension", desc: "Treasure vault key: wrong dimension.", rarity: "junk" },
    lying_oracle_bones: { name: "Convincingly Dishonest Oracle Bones", desc: "Oracle bones that lie convincingly.", rarity: "junk" },
    sweaty_ogre_gauntlets: { name: "Gauntlets of Sweaty Hands", desc: "Gauntlets of Ogre Power: make your hands sweaty.", rarity: "junk" },
    spell_ages_one_day: { name: "\"Spell of Eternal Youth\"", desc: "Spell of Eternal Youth: ages you one day.", rarity: "junk" },
    boring_lost_city_map: { name: "Map to a Boring Lost City", desc: "Map to the Lost City: found it, it's boring.", rarity: "junk" },
    genie_on_vacation_lamp: { name: "Lamp (Genie on Vacation)", desc: "Magic lamp: genie on vacation.", rarity: "junk" },
    bow_wrong_way: { name: "\"Bow of Accuracy\"", desc: "Bow of Accuracy: points the wrong way.", rarity: "junk" },
    paper_cut_amulet: { name: "Amulet of Paper Cut Protection", desc: "Amulet of Protection: from paper cuts.", rarity: "junk" },
    tome_of_dad_jokes: { name: "Tome of Dad Jokes", desc: "Tome of Wisdom: dad jokes only.", rarity: "junk" },
    warm_useless_phoenix_ashes: { name: "Still-Warm Phoenix Ashes", desc: "Phoenix ashes: still warm, useless.", rarity: "junk" },
    ignored_ring_of_truth: { name: "Ring of Ignored Truth", desc: "Ring of Truth: everyone ignores it.", rarity: "junk" },
    toothache_dagger: { name: "Dagger of Toothaches", desc: "Dragon tooth dagger: toothache inducer.", rarity: "junk" },
    scroll_detects_failure: { name: "Scroll of Detected Failure", desc: "Scroll of Detect Magic: detects your failure.", rarity: "junk" },
    helm_intrusive_thoughts: { name: "Helm of Intrusive Thoughts", desc: "Helm of Telepathy: hears intrusive thoughts.", rarity: "junk" },
    bag_of_mothballs: { name: "Bag of Mothballs", desc: "Bag of Tricks: empty except for mothballs.", rarity: "junk" },
    papier_mache_armor: { name: "Legendary Papier-Mâché Armor", desc: "Legendary armor: paper mache.", rarity: "junk" },
    one_ring_snack_drawer: { name: "The One Ring (Snack Drawer Edition)", desc: "The One Ring... to rule the snack drawer.", rarity: "junk" },
  ...
  JUNK_PRIZES: [
    ...
    // Weighted above the other flavor junk — it's the only one tied to a
    // real achievement (100 collected -> suspicious_rocks_100, +1000 stone),
    // so it needs to actually be reachable rather than a 1-in-50 uniform pick.
    { id: "suspicious_rock", msg: "a mysterious rock", weight: 5 },
    ...
    // From fantasy_junk_prizes.md — added on top of the pool above rather than
    // replacing it, so nothing already collected becomes orphaned.
    { id: "map_to_nowhere", msg: "a map to a location that no longer exists" },
    { id: "rusty_butter_knife", msg: "a \"magic\" sword that's just a rusty butter knife" },
    { id: "expired_invisibility_potion", msg: "an expired potion of invisibility (now just water)" },
    { id: "small_dragon_scale", msg: "one slightly used dragon scale (from a very small dragon)" },
    { id: "kings_lost_sock", msg: "the King's lost sock, which smells like regret" },
    { id: "useless_chest_key", msg: "a treasure chest key for a chest long ago plundered" },
    { id: "poverty_glow_ring", msg: "an enchanted ring that only glows when you're broke" },
    { id: "goblins_lucky_tooth", msg: "a goblin's lucky tooth (it bites back)" },
    { id: "scroll_of_annoyance", msg: "a Scroll of Summoning that calls forth mild annoyance" },
    { id: "mismatched_boots_of_speed", msg: "Boots of Speed, left foot only, and mismatched" },
    { id: "crystal_ball_yesterday", msg: "a crystal ball showing yesterday's weather" },
    { id: "houseplant_love_potion", msg: "a love potion that only works on houseplants" },
    { id: "cursed_amulet_bad_decisions", msg: "a cursed amulet (+1 to bad decisions)" },
    { id: "prophecy_fragment_lunch", msg: "a fragment of an ancient prophecy... about lunch" },
    { id: "wand_always_misses", msg: "a Wand of Magic Missiles that always misses" },
    { id: "bag_of_disappointment", msg: "a \"Bag of Holding\" that's really a Bag of Mild Disappointment" },
    { id: "boring_half_artifact", msg: "one half of a legendary artifact — the boring half" },
    { id: "unlit_phoenix_feather", msg: "a phoenix feather that refuses to ignite" },
    { id: "tavern_treasure_map", msg: "a map to buried treasure... buried under a tavern" },
    { id: "pink_camouflage_cloak", msg: "an Elven cloak of camouflage, in bright pink" },
    { id: "sore_muscle_potion", msg: "a Potion of Strength that just makes your muscles sore" },
    { id: "weather_complaining_skull", msg: "a talking skull that only complains about the weather" },
    { id: "judgmental_golden_idol", msg: "a golden idol with a very judgmental face" },
    { id: "boil_water_spellbook_page", msg: "a spellbook page titled \"How to Boil Water, Magically\"" },
    { id: "heartburn_resistance_ring", msg: "a Ring of Fire Resistance that only helps with mild heartburn" },
    { id: "participation_medal", msg: "a hero's medal for participation" },
    { id: "painted_rock_dragon_egg", msg: "a \"dragon egg\" that's actually a rock painted green" },
    { id: "permanently_invisible_ink", msg: "invisible ink that stays invisible forever" },
    { id: "unlucky_rabbits_foot", msg: "a lucky rabbit's foot from a very unlucky rabbit" },
    { id: "mirror_of_truth", msg: "a Mirror of Truth (it tells you you're ugly)" },
    { id: "bad_advice_coin", msg: "an ancient coin that only buys bad advice" },
    { id: "broomstick_staff_of_power", msg: "a \"Staff of Power\" that's actually a broomstick" },
    { id: "curse_of_sneezing", msg: "a Curse of Endless Sneezing" },
    { id: "teleport_scroll_nowhere", msg: "a teleportation scroll to the middle of nowhere" },
    { id: "vinegar_chalice", msg: "a chalice that turns wine into vinegar" },
    { id: "book_of_failure_recipes", msg: "a Book of Forbidden Knowledge (recipes for failure)" },
    { id: "cloak_lifts_spirits", msg: "a Cloak of Levitation that only lifts your spirits" },
    { id: "incomplete_goblin_ears", msg: "an incomplete goblin ear collection" },
    { id: "beans_of_disappointment", msg: "magic beans that grow disappointment" },
    { id: "forgotten_kings_crown", msg: "the crown of the Forgotten King (no one remembers him)" },
    { id: "arrow_of_squirrel_slaying", msg: "an Arrow of Slaying... squirrels" },
    { id: "potion_of_the_runs", msg: "a \"Potion of Flight\" that just gives you the runs" },
    { id: "singing_sword_shanties", msg: "a singing sword that only knows tavern shanties" },
    { id: "hangover_crystal", msg: "a crystal that predicts your next hangover" },
    { id: "zombie_attracting_amulet", msg: "an amulet against undead that attracts zombies instead" },
    { id: "dried_fountain_of_youth_map", msg: "a map to the Fountain of Youth, now dried up" },
    { id: "helm_of_foolishness", msg: "a \"Helm of Brilliance\" that makes you look foolish" },
    { id: "bag_of_lint", msg: "a bag of endless... lint" },
    { id: "flower_resurrection_scroll", msg: "a Scroll of Resurrection that only revives wilted flowers" },
    { id: "excalibore", msg: "the legendary blade \"Excali-bore\"" },
    { id: "orb_of_static", msg: "an Orb of Scrying that only shows static" },
    { id: "dramatically_squeaky_boots", msg: "boots that squeak dramatically with every step" },
    { id: "ghost_ex_love_letter", msg: "a love letter from a ghost ex" },
    { id: "dice_of_fate_always_one", msg: "Dice of Fate that always roll a 1" },
    { id: "mild_polymorph_potion", msg: "a Potion of Polymorph that turns you into a slightly different person" },
    { id: "drunk_bards_map", msg: "a treasure map drawn by a drunk bard" },
    { id: "shield_of_insecurities", msg: "a Shield of Reflection that reflects your insecurities" },
    { id: "hair_igniting_wand", msg: "a wand that shoots sparks and sets your hair on fire" },
    { id: "tome_101_ways_lose_kingdom", msg: "an ancient tome, \"101 Ways to Lose a Kingdom\"" },
    { id: "ring_hopes_dreams", msg: "a Ring of Invisibility that works on your hopes and dreams" },
    { id: "dragons_hoard_lint", msg: "a dragon's hoard — one copper piece and lint" },
    { id: "healing_potion_regret", msg: "a healing potion that tastes like regret" },
    { id: "prophecy_stone_inconvenience", msg: "a prophecy stone that foretells mild inconvenience" },
    { id: "clashing_cloak", msg: "a Cloak of Many Colors, all of which clash" },
    { id: "key_to_ruined_city", msg: "a key to the city... of ruins" },
    { id: "pigeon_summoning_whistle", msg: "a familiar summoning whistle that only calls pigeons" },
    { id: "dice_weighted_against_you", msg: "enchanted dice, weighted against you" },
    { id: "mirror_shield_worst_side", msg: "a Mirror Shield that shows your worst side" },
    { id: "bottle_of_more_wishes", msg: "a bottle of genie wishes, one left, and it's \"more wishes\"" },
    { id: "el_dorado_thrift_shop_map", msg: "a map to El Dorado that's actually a thrift shop" },
    { id: "sword_dulls_on_contact", msg: "a \"Sword of Sharpness\" that dulls on contact" },
    { id: "book_of_spell_typos", msg: "a Book of Spells that's entirely typos" },
    { id: "orc_charisma_crown", msg: "a crown that gives +1 charisma, but only to orcs" },
    { id: "teleport_ring_last_death", msg: "a teleport ring to the last place you died" },
    { id: "potion_everything_faster", msg: "a \"Potion of Speed\" that just makes everything else faster" },
    { id: "three_leaf_clover", msg: "a lucky charm — a four-leaf clover with three leaves" },
    { id: "ancient_broken_pottery", msg: "an ancient relic (broken pottery)" },
    { id: "dimly_glowing_staff", msg: "a \"Staff of Light\" that dimly glows" },
    { id: "curse_swap_scroll", msg: "a curse removal scroll that just applies another curse" },
    { id: "tomato_stained_cape", msg: "a hero's cape, stained with tomato sauce" },
    { id: "plastic_crystal_skull", msg: "a \"crystal\" skull that's actually plastic" },
    { id: "rug_with_attitude", msg: "a \"flying carpet\" that's really just a rug with attitude" },
    { id: "toad_love_elixir", msg: "a love elixir that only works on toads" },
    { id: "wrong_dimension_vault_key", msg: "a treasure vault key for the wrong dimension" },
    { id: "lying_oracle_bones", msg: "oracle bones that lie convincingly" },
    { id: "sweaty_ogre_gauntlets", msg: "Gauntlets of Ogre Power that just make your hands sweaty" },
    { id: "spell_ages_one_day", msg: "a \"Spell of Eternal Youth\" that ages you exactly one day" },
    { id: "boring_lost_city_map", msg: "a map to the Lost City — found it, it's boring" },
    { id: "genie_on_vacation_lamp", msg: "a magic lamp whose genie is on vacation" },
    { id: "bow_wrong_way", msg: "a \"Bow of Accuracy\" that points the wrong way" },
    { id: "paper_cut_amulet", msg: "an Amulet of Protection — from paper cuts" },
    { id: "tome_of_dad_jokes", msg: "a Tome of Wisdom containing only dad jokes" },
    { id: "warm_useless_phoenix_ashes", msg: "phoenix ashes, still warm and completely useless" },
    { id: "ignored_ring_of_truth", msg: "a Ring of Truth that everyone ignores" },
    { id: "toothache_dagger", msg: "a dragon tooth dagger that induces toothaches" },
    { id: "scroll_detects_failure", msg: "a Scroll of Detect Magic that detects your failure" },
    { id: "helm_intrusive_thoughts", msg: "a Helm of Telepathy that just hears intrusive thoughts" },
    { id: "bag_of_mothballs", msg: "a Bag of Tricks, empty except for mothballs" },
    { id: "papier_mache_armor", msg: "legendary armor made of paper mache" },
    { id: "one_ring_snack_drawer", msg: "the One Ring... to rule the snack drawer" },
  ],
  ...
  // Junk messages for resource production random events (20% worthless
  // find), by resource type — matches RARE_RESOURCE_ITEMS' per-type shape.
  RESOURCE_JUNK_MESSAGES: {
    ...
    stone: [
      "Your quarry workers found a rock shaped exactly like a potato. Morale improved slightly.",
      "Workers unearthed a chisel from a previous crew. The handle says 'DO NOT BORROW'.",
      "Your masons discovered a vein of rock that echoes when tapped. Nobody investigated further.",
      "A stonecutter swore the block he was working on winked at him. It did not.",
      "Workers found a perfectly cube-shaped stone. They argued about who gets to keep it.",
      "Your quarry crew unearthed an old boundary marker for a kingdom nobody remembers.",
      "A pickaxe struck something hollow. It was just an air pocket. Everyone was disappointed.",
      "Workers discovered a family of bats living in the quarry wall. The bats have seniority now.",
      "Your stonecutters found a fossil that looks suspiciously like a hand. It is not a hand.",
      "A quarryman's echo came back sounding slightly judgmental. Work continued regardless.",
      "Workers unearthed a stone tablet covered in illegible scratches. Probably not important.",
      "Your masons discovered the quarry had been mined here before, by someone with worse tools.",
      "A block split open to reveal nothing but more rock. The workers were briefly optimistic.",
      "Workers found a very smooth stone that skips well. It was pocketed instead of used.",
      "Your quarry crew unearthed a rusted horseshoe. No horse was ever found nearby.",
    ],
    iron: [
      "Your miners struck a vein that turned out to be pyrite. Fool's gold fools nobody twice.",
      "Workers found an old pickaxe head with no handle. It joined the collection of the same.",
      "Your smiths discovered a lump of ore shaped vaguely like a crown. It was smelted anyway.",
      "A miner's lantern flickered ominously for a moment, then worked fine. Everyone kept digging.",
      "Workers unearthed a cracked helmet from a battle nobody remembers fighting.",
      "Your ore-diggers found a tunnel someone else had already dug, decades ago, going nowhere.",
      "A pickaxe struck a pocket of gas that smelled faintly of eggs. Work paused briefly.",
      "Workers discovered an old mining tally scratched into the wall. The count doesn't add up.",
      "Your miners found a chunk of ore too soft to be useful and too hard to ignore.",
      "A cart wheel came loose in the deep shaft. It rolled further than anyone expected.",
      "Workers unearthed a rusted key to a lock that no longer exists.",
      "Your smiths swear the ore hums faintly at midnight. It does not hum during the day either.",
      "A miner found a vein that looked promising, then turned out to be mostly clay.",
      "Workers discovered graffiti scratched into the tunnel wall reading 'turn back'. They didn't.",
      "Your ore-diggers unearthed an old boot buried in the shaft wall. No further boots were found.",
    ],
  },
  ...
  ACHIEVEMENTS: {
    ...
    ach_constructor: {
      title: "Constructor",
      description: "Build 1500 structures.",
      reward: "Smithies (total reaches 100)",
    },
    ach_colossus: {
      title: "Colossus",
    ...
    suspicious_rocks_100: {
      title: "Rock Collector",
      description: "Find 100 Suspicious Rocks during expeditions.",
      reward: "1000 Stone",
    },
    collector: {
      title: "Field Collector",
      description: "Find 50 unique curiosities during expeditions.",
      reward: "Reveals all world locations",
    },
    historian: {
      title: "Historian",
      description: "Discover all library lore.",
      reward: "5000 Maps",
    },
  },
  ...
  FORGE_UPGRADE_COSTS: {
    ...
    engineers_lodge: { wood: 500, stone: 2500, iron: 2000, gold: 75000, turns: 30 },
    forge: { wood: 800, stone: 4000, iron: 3500, gold: 150000, turns: 40 },
  },
  /** Instant install via POST /forge/install-upgrade (handshake). turns reserved for queue if added later. */
  FORGE_UPGRADE_INSTANT: true,
  FORGE_YARD_HAMMER_GOLD_MULT: 0.9,
  FORGE_YARD_SCAFFOLD_USE_MULT: 0.9,
  FORGE_LODGE_ENG_XP_MULT: 1.15,
  FORGE_LODGE_CONSTRUCT_MULT: 1.1,
  FORGE_CHARCOAL_WOOD_RATIO: 0.25,
  FORGE_COAL_CAP: 5000,
  FORGE_SMELT: { iron: 20, coal: 10, steel: 1 },
  FORGE_TEMPER: { steel: 1, lava: 2, tempered_steel: 1 },
  FORGE_GEAR_COSTS: {
    steel_weapons: { steel: 5, gold: 10000 },
    steel_armor: { steel: 5, gold: 12000 },
    tempered_weapons: { tempered_steel: 3, gold: 25000 },
    tempered_armor: { tempered_steel: 3, gold: 30000 },
  },
  FORGE_BARGE: {
    max: 3,
  ...
  FORGE_LAVA: {
    ...
    on_site_turns: 100,
    base_yield: 8,
    dormant_ms: 3 * 60 * 60 * 1000,
    xp_success: { engineers: 10000, mages: 2500 },
    xp_empty: { engineers: 1500, mages: 400 },
  },
  FORGE_RACE_MULT: {
    dwarf: { charcoal: 0.8, smelt: 1.25, lava: 1.25 },
    high_elf: { charcoal: 1.25, smelt: 1.1, lava: 0.8 },
    wood_elf: { charcoal: 1.25, smelt: 1.0, lava: 0.75 },
    orc: { charcoal: 1.0, smelt: 1.1, lava: 1.1 },
    ogre: { charcoal: 0.85, smelt: 1.2, lava: 1.1 },
    human: { charcoal: 1.1, smelt: 1.1, lava: 1.0 },
    dark_elf: { charcoal: 0.85, smelt: 1.05, lava: 1.05 },
    vampire: { charcoal: 0.95, smelt: 1.0, lava: 1.0 },
    dire_wolf: { charcoal: 0.7, smelt: 0.7, lava: 0.65 },
  },
  TEMPERED_STEEL_NAMES: {
    high_elf: "Runesteel",
    dwarf: "Stonesteel",
    human: "Crownsteel",
    dire_wolf: "Rimesteel",
