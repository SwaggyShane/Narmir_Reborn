// Active effects domain: per-turn tick-down and resolution of time-limited
// kingdom effects (blight, plague, silence, summon_rats, etc.).
...
module.exports = { processActiveEffects };
