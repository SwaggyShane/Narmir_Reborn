...
const GoalsPanel = () => {
  ...
  const fetchGoals = useCallback(async () => {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && typeof window.toast === 'function') window.toast('Failed to fetch goals', 'error');
    }
    setLoading(false);
  }, []);
  ...
  const claimGoal = async (groupId, goalId) => {
    try {
      ...
      if (res && res.ok) {
        if (typeof window !== 'undefined' && typeof window.toast === 'function') window.toast(res.message, "success");
      ...
      if (typeof window !== 'undefined' && typeof window.toast === 'function') window.toast(e.message || "Failed to claim goal", "error");
    }
  };
