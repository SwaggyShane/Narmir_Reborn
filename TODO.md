...
**Phase 3: Scout Loop + Server Gating** — Partial (slices merged PR #762, #764 2026-07-03; see ARCHIVAL.md)
- Slices complete: `/scout-area`, node reveal, world-map gating, trade routes gating, expedition ahead reveal (on launch + process), expeditions filter in world-map.
- Remaining: full endpoints gating (diplomacy, etc.), client scout UI, validation matrix tests.
