...
**Phase 4: Fog Rendering** (started)
- SVG fog overlay in `WorldmapRenderer.jsx` (unseen/seen/current states, reduced-motion support) — initial implementation via PR #772 (visibility exposure + fog layer; leak fix).
