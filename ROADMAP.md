...
**Status:** Alpha phase (ongoing) — Tracks A–D complete; E1–E2 fixed; E3 deferred (await discord.js v15); Track F.3 consolidation complete (PR #606–#608); **F.4 engine.js decomposition COMPLETE (PR #611); F.2 Combat V2 complete and alpha-ready (PR #612); F.5 Phase 1 ALL 16 COMPONENTS COMPLETE (PR #617–#641); F.6 Phase 1 COMPLETE (PR #642): Vitest + RTL infrastructure with 57 tests (panelMeta + BottomNav); F.7 Phase 1–3 COMPLETE (PR #643–#645): Numeric range validation utility + full endpoint integration; F.8 Phase 2b COMPLETE (PR #649): /attack and /spell endpoints now transaction-safe with sorted locking**  
**Last updated:** 2026-06-28 (F8 Phase 2b COMPLETE: Implemented full transaction-based concurrency prevention for /attack and /spell endpoints, mirroring proven /covert pattern; manual BEGIN TRANSACTION with sorted kingdom locking (ascending ID); all validations inside transaction with explicit ROLLBACK; lint 0 errors, smoke passing, Gemini reviews resolved; Phase 3 (remove duplicates) queued)
