...
**Status:** Alpha phase (ongoing) — Tracks A–D complete; E1–E2 fixed; E3 deferred (await discord.js v15); Track F.3 consolidation complete (PR #606–#608); **F.4 engine.js decomposition COMPLETE (PR #611); F.2 Combat V2 complete and alpha-ready (PR #612); F.5 Phase 1 ALL 16 COMPONENTS COMPLETE: PR #3–#6 (PR #617–#620), PR #9–#10 (PR #624–#625), PR #12 (PR #628), PR #13 (PR #629), PR #4 (PR #630), PR #3 (PR #631), PR #14 (PR #632), PR #15 (PR #633), PR #16 (PR #634), PR #17 (PR #635), PR #18 (PR #636), PR #19 (PR #637), PR #20 (PR #638), PR #21 (PR #639), PR #22 (PR #640), PR #23 (PR #641); Architectural foundation COMPLETE (PR #627); F5 Phase 1 complete — all light-state + complex components migrated to Zustand**  
**Last updated:** 2026-06-27 (F5 Phase 1 COMPLETE: 16 components migrated (OptionsPanel, HeroesPanel, ExplorationPanel, TrainingPanel, WarfarePanel, BuildPanel, HappinessPanel, StatusPanel, HappinessWidget, HirePanel, RankingsPanel, DefensePanel, KingdomXpModal, EconomyPanel, MarketPanel, ResourcesPanel); architectural foundation deployed; ready for F6+)
