...
**Status:** Alpha phase (ongoing) — Tracks A–D complete; E1–E2 fixed; E3 deferred (await discord.js v15); Track F.3 consolidation complete (PR #606–#608); **F.4 engine.js decomposition COMPLETE (PR #611); F.2 Combat V2 complete and alpha-ready (PR #612); F.5 Phase 1 PR #3–#6 COMPLETE (PR #617–#620); PR #9–#10 COMPLETE (PR #624–#625); Architectural foundation COMPLETE (PR #627); PR #12 COMPLETE (PR #628 ExplorationPanel); Paused PR #11 (StudiesPanel) — foundation ready; pipeline: TrainingPanel → WarfarePanel → BuildPanel**  
**Last updated:** 2026-06-27 (F5 Phase 1: 3 light-state components migrated; architectural foundation deployed; ready for complex component refactors)  
