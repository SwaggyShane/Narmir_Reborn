...
**Status:** Alpha phase (ongoing) — Tracks A–D complete; E1–E2 fixed; E3 deferred (await discord.js v15); Track F.3 consolidation complete (PR #606–#608); **F.4 engine.js decomposition COMPLETE (PR #611); F.2 Combat V2 complete and alpha-ready (PR #612); F.5 Phase 1 ALL 16 COMPONENTS COMPLETE (PR #617–#641); F.6 Phase 1 COMPLETE (PR #642): Vitest + RTL infrastructure with 57 tests (panelMeta + BottomNav); F.7 Phase 1–3 COMPLETE (PR #643–#645): Numeric range validation utility + full endpoint integration; F.8 Phase 2b, 3, & 4 COMPLETE (PR #649): Transaction safety for /attack & /spell; removed duplicate warfare endpoints; extracted economy module**  
**Last updated:** 2026-06-28 (F8 Phase 2b, 3 & 4 COMPLETE: Full transaction-based concurrency prevention; removed 10 duplicate warfare endpoints (1,037 lines); extracted 17 economy endpoints to kingdom-economy.js (894 lines); removed unused variables; lint 0 errors, smoke passing, sanity verified)
