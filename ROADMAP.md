...
**Status:** Alpha phase (ongoing) — Tracks A–D complete; E1–E2 fixed; E3 deferred (await discord.js v15); Track F.3 consolidation complete (PR #606–#608); **F.4 engine.js decomposition COMPLETE (PR #611); F.2 Combat V2 complete and alpha-ready (PR #612); F.5 Phase 1 PR #3–#6 COMPLETE (PR #617, #618, #619, #620 merged); PR #9 COMPLETE (PR #624 OptionsPanel merged); PR #10+ queued**  
**Last updated:** 2026-06-27 (F5 Phase 1: PR #3–#6 merged; PR #9 complete; PR #10+ queued)  
...
| **F5** | `GameStateManager` → Zustand | 5-PR incremental migration; Phase 1 (Store infrastructure + all tier-1 panels) | Post-F4 | ✅ **PR #3–#6 COMPLETE (PR #617, #618, #619, #620 merged); PR #9 COMPLETE (PR #624 OptionsPanel merged); PR #10+ queued** |
