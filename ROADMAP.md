...
**Status:** Alpha phase (ongoing) — Tracks A–D complete; E1–E2 fixed; E3 deferred (await discord.js v15); Track F.3 consolidation complete (PR #606–#608); **F.4 engine.js decomposition COMPLETE (PR #611); F.2 Combat V2 complete and alpha-ready (PR #612); F.5 Phase 1 ALL 16 COMPONENTS COMPLETE (PR #617–#641); F.6 Phase 1 COMPLETE (PR #642): Vitest + RTL infrastructure with 57 tests (panelMeta + BottomNav); F.7 Phase 1–2 COMPLETE (PR #643–#644): Numeric range validation utility + endpoint integration with type coercion security fixes**  
**Last updated:** 2026-06-27 (F7 Phase 2 COMPLETE: Integrated validators into 5 kingdom.js endpoints (/hire, /research, /research-allocation, /training-allocation, /build-queue); strict type checking; all CI passing; merged to main)
...
| **F7** | Numeric range validation (troops, builds, research) | Prevents balance exploits | Post-F4 | ✅ **COMPLETE** (PR #643–#644) — Phase 1: 8 validators, 30 tests, type coercion security fixes; Phase 2: Integrated into 5 endpoints (/hire, /research, /research-allocation, /training-allocation, /build-queue) |
