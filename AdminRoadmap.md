...
**Status:** Phase 3 in progress — Manage tab implemented  
...
3. **Phase 3 PR** — IN PROGRESS. ManagePanel: announcements, AI hiatus, chat mods/bans, promote admin, test kingdoms, bulk/destructive actions.
