...
// CORS '*', no view caching). Mutating process.env is safe: libraries read it lazily.
if ((process.env.NODE_ENV || '').toLowerCase() === 'production') process.env.NODE_ENV = 'production';
