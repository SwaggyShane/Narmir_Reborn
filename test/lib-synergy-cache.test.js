...
// Test 8: combat-relevant synergy bonuses cap at +50%
{
  const k = {
    fragment_bonuses: JSON.stringify({
      ...
      guard_towers: { fragment: 'Abyssal Crystal', applied_turn: 0, passive: {}, special: {} },
      vaults: { fragment: 'Cursed Bloodstone', applied_turn: 0, passive: {}, special: {} },
      barracks: { fragment: 'Dragon Scale', applied_turn: 0, passive: {}, special: {} },
      castles: { fragment: 'Volcanic Rock', applied_turn: 0, passive: {}, special: {} },
      outposts: { fragment: 'Dwarven Star-Metal', applied_turn: 0, passive: {}, special: {} },
      markets: { fragment: 'Celestial Feather', applied_turn: 0, passive: {}, special: {} },
      training: { fragment: 'Ancient Elven Wood', applied_turn: 0, passive: {}, special: {} },
      walls: { fragment: 'Titan Bone', applied_turn: 0, passive: {}, special: {} },
      schools: { fragment: 'Tears of the World Tree', applied_turn: 0, passive: {}, special: {} },
    }),
  };
...
// Test 9: non-combat synergy bonuses remain uncapped
{
  ...
  const happinessKingdom = {
    fragment_bonuses: JSON.stringify({
      castles: { fragment: 'Cursed Bloodstone', applied_turn: 0, passive: {}, special: {} },
